  ...
  class Program
  {
    ...
    static void Main(string[] args)
    {
      ...
      FileCache[] fileCacheTests = 
      {
        ...
        // FileCache with a specific file storage and BufferSize
        // файловый кэш с указанием хранилища файлов и объемом буфера в 100 Мб
        new FileCache(@"C:\cache\myapp", 102400),
        ...
        // файловый кэш без использования буфера, 
        // но с указанием времени ожидания освобождения файлов
        new FileCache(@"C:\cache\myapp", 0) { AccessTimeout = new TimeSpan(0, 0, 1) }
      };
      ...
      foreach (FileCache fileCache in fileCacheTests)
      {
        ...
        #endregion
        #region multithreads caching

        Console.WriteLine("Multithreads caching...");

        var sw = new Stopwatch();
        sw.Start();
        int threads = 0, errors = 0, ok = 0;
        ...
        sw.Restart();
        Console.WriteLine("Multithreads rewriting data caching...");

        threads = 0; errors = 0; ok = 0;
